...
std::shared_ptr<Book> Loan::getBook() const { return book; }

std::shared_ptr<User> Loan::getUser() const { return user; }

std::chrono::system_clock::time_point Loan::getLoanDate() const { return loanDate; }

std::chrono::system_clock::time_point Loan::getReturnDate() const { return returnDate; }
